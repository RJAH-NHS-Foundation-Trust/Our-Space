      ...
      <div class="col-md-4 mb-4">
        <a class="custom-card-link" target="_blank" href="https://www.moneyhelper.org.uk/">
          <div class="card custom-card d-flex flex-column h-100">
            ...
            <img src="<?php echo get_bloginfo('template_directory'); ?>/img/money-helper.webp" class="card-img-top" alt="Money Helper">
            <div class="card-body">
      ...
      <div class="col-md-4 mb-4">
        <a class="custom-card-link" href="<?php echo get_option('home'); ?>/financial-support">
          <div class="card custom-card d-flex flex-column h-100">
            ...
            <img src="<?php echo get_bloginfo('template_directory'); ?>/img/finances.webp" class="card-img-top" alt="Financial Support">
            <div class="card-body">
      ...
      <div class="col-md-4 mb-4">
        <a class="custom-card-link" href="<?php echo get_option('home'); ?>/discount-codes">
          <div class="card custom-card d-flex flex-column h-100">
            ...
            <img src="<?php echo get_bloginfo('template_directory'); ?>/img/discount-codes.webp" class="card-img-top" alt="Discount Codes">
            <div class="card-body">

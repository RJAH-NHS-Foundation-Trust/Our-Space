...
<div class="container mt-4">
    ...
    <div class="alert alert-secondary">
      The routes below are provided as guidelines only, it is important to work within your own limits and consult your doctor before starting any new exercises.
    </div>
</div>
    ...
    <div class="container">
        <div class="row g-grid gap-2 w-100 d-flex">
            <?php if ( $posts->have_posts() ) :  while ( $posts->have_posts() ) : $posts->the_post(); 
                get_template_part( 'partials/routes-content', get_post_format() );
                    endwhile; ?>
                    </div>

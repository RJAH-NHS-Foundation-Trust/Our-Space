...
<div class="row mt-2">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" target="_blank" href="https://hdsunflower.com/uk/">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/sunflower.png" class="card-img-top" alt="The Sunflower Hidden Disabilities">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/access-to-work">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/access-to-work.png" class="card-img-top" alt="Access To Work">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" target="_blank" href="https://rnid.org.uk/">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/hearing-loss.png" class="card-img-top" alt="Hearing Loss">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" target="_blank" href="https://www.rnib.org.uk/">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/sight-loss.png" class="card-img-top" alt="Sight Loss">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" target="_blank" href="https://crohnsandcolitis.org.uk/">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/chrons.png" class="card-img-top" alt="Crohns & Colitis">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/autism">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/autism.png" class="card-img-top" alt="Autism">
          <div class="card-body">
    ...
    <a class="custom-card-link" href="<?php echo get_option('home'); ?>/ocd">
      <div class="card custom-card d-flex flex-column h-100">
        ...
        <img src="<?php echo get_bloginfo('template_directory'); ?>/img/ocd.png" class="card-img-top" alt="OCD">
        <div class="card-body">

    ...
    <div class="col-md-4 mb-4">
        <a class="custom-card-link" target="_blank" href="https://www.nhs.uk/live-well/quit-smoking/nhs-stop-smoking-services-help-you-quit/">
          <div class="card custom-card d-flex flex-column h-100">
            ...
            <img src="<?php echo get_bloginfo('template_directory'); ?>/img/stop-smoking.webp" class="card-img-top" alt="Image Alt">
            <div class="card-body">
      ...
      <div class="col-md-4 mb-4">
        <a class="custom-card-link" target="_blank" href="https://www.nhs.uk/live-well/alcohol-advice/alcohol-support/">
          <div class="card custom-card d-flex flex-column h-100">
            ...
            <img src="<?php echo get_bloginfo('template_directory'); ?>/img/alcohol.webp" class="card-img-top" alt="Image Alt">
            <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" target="_blank" href="https://www.diabetes.org.uk/">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/diabetes.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" target="_blank" href="https://legsmatter.org/">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/legs-matter.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/sanitary-products">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/sanitary-products.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" target="_blank" href="<?php echo get_bloginfo('template_directory'); ?>/files/StaffSelfReferralPhysiotherapyService.pdf">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/physio.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">

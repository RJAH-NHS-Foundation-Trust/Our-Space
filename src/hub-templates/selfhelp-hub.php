...
<div class="row mt-2">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/podcasts">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/podcast.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/books">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/books.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <a class="custom-card-link" href="<?php echo get_option('home'); ?>/groups">
      <div class="card custom-card d-flex flex-column h-100">
        ...
        <img src="<?php echo get_bloginfo('template_directory'); ?>/img/groups.webp" class="card-img-top" alt="Image Alt">
        <div class="card-body">

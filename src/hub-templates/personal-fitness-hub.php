    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/desk-exercises">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/desk-workout.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/exercises">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/exercise.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/workouts">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/workouts.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/exercise-routes">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/walking-routes.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/gyms">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/local-gym.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/cycle-to-work-scheme">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/cycle-to-work.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" target="_blank" href="https://www.strava.com/clubs/ourspace">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/strava-club.webp" class="card-img-top" alt="Image Alt">
          <div class="card-body">

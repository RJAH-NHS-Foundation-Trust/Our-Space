...
<div class="row mt-2">
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/anxiety">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/anxiety.webp" class="card-img-top" alt="Anxiety">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/depression">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/depression.webp" class="card-img-top" alt="Depression">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/counselling">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/counselling.webp" class="card-img-top" alt="Counselling">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <a class="custom-card-link" href="<?php echo get_option('home'); ?>/bipolar">
        <div class="card custom-card d-flex flex-column h-100">
          ...
          <img src="<?php echo get_bloginfo('template_directory'); ?>/img/bipolar.webp" class="card-img-top" alt="Bipolar">
          <div class="card-body">
  ...
  <div class="col-md-4 mb-4">
    <a class="custom-card-link" href="<?php echo get_option('home'); ?>/addiction">
      <div class="card custom-card d-flex flex-column h-100">
        <span class="custom-pill">Addiction</span>
        <img src="<?php echo get_bloginfo('template_directory'); ?>/img/addiction.webp" class="card-img-top" alt="Addiction">
        <div class="card-body">
          <p class="card-text">Addiction is defined as not having control over doing, taking or using something to the point where it could be harmful to you.</p>
        </div>
      </div>
    </a>
  </div>
